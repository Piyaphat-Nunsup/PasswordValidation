...
public class TestRunner {
    ...
    public static void main(String[] a) {
        ...
        check("pw len = 8",PasswordValidator.validate("aA125asF")== true);
        check("pw len < 8",PasswordValidator.validate("ASDGDSH")== false);
        check("pw len > 20",PasswordValidator.validate("ASDGDSHSrvryrytuu6161165")== false);
        // TODO: R3 - ไม่มีตัวพิมพ์ใหญ่ -> false
        check("pw no upper",PasswordValidator.validate("golf56789")== false);
        // TODO: R4 - ไม่มีตัวพิมพ์เล็ก -> false
        check("pw no lower",PasswordValidator.validate("GOLF56789")== false);
        // TODO: R5 - ไม่มีตัวเลข -> false
        check("pw no number",PasswordValidator.validate("GolfGolf")== false);
        // TODO: R6 - มีช่องว่าง -> false
        check("pw have space",PasswordValidator.validate("G olfGolf")== false);
        // TODO: boundary อื่นๆ ที่คุณคิดว่าจำเป็น
        check("pw have special characters ",PasswordValidator.validate("GolfGolf")== false);
        System.out.println("==================================");
